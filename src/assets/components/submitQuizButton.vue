<template>
    <div>
        <button :disabled="!allClicked" class='subQuizButton' @click="show = !show">Submit Quiz</button>
    </div>
...
defineProps({ learnerType: String, description: String, allClicked: Boolean });
let show = ref(false);
let learnTypeLink = '';
let learnTypeLogo = '';
let leenteep = '';
